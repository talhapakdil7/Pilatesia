              ...
              <div className="card shadow-sm h-100">
                <div className="card-body">
                  ...
                  <div className="small">
                    ...
                    <div><b>Kapasite:</b> {l.capacity} kişi ({(l.remaining_seats ?? l.capacity)} kalan)</div>
                  </div>
                </div>
                <div className="card-footer bg-white border-0 p-3">
                  {(l.remaining_seats ?? l.capacity) <= 0 ? (
                    <button className="btn btn-outline-secondary w-100" disabled>Dolu</button>
                  ) : (
                    <button
