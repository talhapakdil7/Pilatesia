            ...
            {data.studio && (
              <div className="d-flex align-items-center gap-2 mb-4 p-3 rounded-3 bg-light">
                <div className="studio-icon">
                  <i className="bi bi-building" style={{ fontSize: "1.5rem", color: "var(--pilatesia-primary)" }} />
                </div>
                <div>
                  <div className="text-muted small">Stüdyonuz</div>
                  <div className="fw-bold">{data.studio.name}</div>
                  <code className="text-muted small">{data.studio.code}</code>
                </div>
              </div>
            )}
