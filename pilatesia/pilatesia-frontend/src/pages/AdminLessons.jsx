            ...
            <div className="modal-content">
              ...
              <form onSubmit={save}>
                <div className="modal-body">
                  ...
                  <div className="mb-2">
                    <label className="form-label">Başlangıç (örn. 2026-03-05 10:00) *</label>
                    <input className="form-control" value={form.start_time} onChange={(e) => setForm({ ...form, start_time: e.target.value })} required />
                  </div>
                  <div className="row">
